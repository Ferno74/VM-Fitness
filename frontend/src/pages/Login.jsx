...
import { ArrowRight, Lock, Mail } from 'lucide-react'; // Using lucide-react for input icons
    ...
    <div className="min-h-[calc(100vh-48px)] flex items-center justify-center bg-[#09090B] px-6 py-20 relative overflow-hidden selection:bg-accent selection:text-white">
      ...
      <div className="w-full max-w-md bg-[#18181B] border border-white/5 rounded-3xl p-8 md:p-10 shadow-2xl relative z-10">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-display font-bold text-white tracking-tight mb-2">Member Login</h1>
          <p className="text-white/40 text-sm tracking-wide">Enter your credentials to access the ecosystem.</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-white/40 text-sm">
            Don't have an access profile?{' '}
            <Link to="/register" className="text-accent hover:text-yellow-500 font-medium transition-colors">
              Request Access
            </Link>
          </p>
        </div>
